...
> Actually, that last comment is already outdated. Now that we've doubled the number available images, the new images are showing up as a new distribution on the low end. 
