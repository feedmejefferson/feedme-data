...
The `v` component of our SVD output is the right decompsed matrix from our singular value decomposition. Each column of this matrix will rank all of our foods on a different dimension -- the first column being the most significant of those dimensions. We can visualize each of these dimensions in the same way that we visualized popularity -- by displaying the top and bottom ten foods for each dimension.
